CC = gcc
CFLAGS = -std=c99 -Wextra -g -Wall
CTEST_FLAGS = -std=c99
LDFLAGS = -lcriterion

SOURCES = src/command_line_parser.c src/errors.c src/file_system.c src/command_new.c src/templates.c src/logger.c src/manifest.c src/toml.c src/command_init.c src/common.c
